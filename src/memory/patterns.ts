...
export const EXPLICIT_REMEMBER: PatternCategory = {
  ...
  nonLatin: [
    '临时任务记忆', '临时跨项目记忆', '跨项目临时上下文', '临时上下文',
    '臨時任務記憶', '臨時跨專案記憶', '跨專案臨時上下文', '臨時上下文',
    '帮我记一下', '帮我记住', '请记一下', '请记住', '记住这个',
    '不要忘记', '需要记住', '记下来', '记一下', '别忘了',
    '记住', '牢记', '重要的是', '注意',
    '幫我記一下', '幫我記住', '請記一下', '請記住', '記住這個',
    '不要忘記', '需要記住', '記下來', '記一下', '別忘了',
    '記住', '牢記', '重要的是', '注意',
    // Japanese
